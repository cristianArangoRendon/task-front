...
export class HttpService implements IHttpService{
  ...
  private handleError(error: any): Observable<never> {
    this._notificationsService.showErrorMessage(error);
    throw error;
  }
  ...
  private performHttpRequest<T>(urlServie: string,method: 'get' | 'post' | 'put' | 'delete', endpoint: string, params?: any, body?: any): Observable<T> {
  ...
  get(urlServie: string,endpoint: string, params?: any): Observable<ResponseDTO> {
    return this.performHttpRequest<ResponseDTO>(urlServie,'get', endpoint, params);
  }
